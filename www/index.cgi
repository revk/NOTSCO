...
<p>Under OFCOM General Conditions, One Touch Switching is mandatory for all UK fixed broadband and fixed telephony providers with consumer customers, even if just retail providers of someone elsek&apos;s service.</p>
...
<p>We have tried to follow the spec, let us know if you think there is any error. Please bear in mind the specifications are <i>woolly</i> at best. We have tried to reference the specification as much as possible, but some is based on examples and messages actually seen from TOTSCO. We&apos;re happy to take on suggestions in improving our checking.</p>
