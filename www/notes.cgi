...
<p>TOTSCO Bulletin 66 goes further and assumes that every message has a unique source correlationID so duplicates can be detected at the recipient side. So a new UUID for each message is recommended.</p>
