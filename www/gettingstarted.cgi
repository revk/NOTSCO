...
<p>The first step is <a href="/connection.cgi">Connection and authentication</a> which allows you set up the connection URLs, client ID and client secret for messages each way, and your details.</p>
