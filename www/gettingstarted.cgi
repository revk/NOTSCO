...
<p>The first step if <a href="/connection.cgi">Connection and authentication</a> which allows you set up teh domain names, client ID and client secret for messages ech way, and your details.</p>
